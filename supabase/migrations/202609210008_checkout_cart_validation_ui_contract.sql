-- Checkout v2 UI contract: expose the cart resolution column as `action`.
-- The previous migration used `resolution`; this keeps the same behavior while
-- making the RPC payload explicit for the checkout client.
...
'Checkout v2 preflight. action=remove removes an unavailable exact variant; action=reduce clamps quantity; action=ok leaves the cart line unchanged.';
