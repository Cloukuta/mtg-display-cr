...
export default function CatalogInventoryEditor(){
 ...
 return <><style>{`
section.sticky.shadow-2xl {
 position: fixed !important;
 top: auto !important;
 bottom: 20px !important;
 left: 50% !important;
 width: min(calc(100% - 40px), 80rem) !important;
 max-width: 80rem !important;
 margin: 0 !important;
 transform: translateX(-50%) !important;
 z-index: 60 !important;
}
main:has(section.sticky.shadow-2xl) { padding-bottom: 120px; }
@media (max-width: 767px) {
 section.sticky.shadow-2xl { bottom: 10px !important; width: calc(100% - 20px) !important; }
 main:has(section.sticky.shadow-2xl) { padding-bottom: 180px; }
}
